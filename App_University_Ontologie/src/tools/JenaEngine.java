...
public class JenaEngine {
    static private String RDF = "http://www.w3.org/2002/07/owl#";
     ...
     * + Sortie: l'objet OntModel jena
     */
    static public OntModel readModel(String inputDataFile) {
//		 create an empty model
     ...
     */
    static public String executeQuery(OntModel model, String queryString) {
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public String executeQueryFile(OntModel model, String filepath) {
        ...
        String queryString = tool.getContents(queryFile);
     ...
     * + Sortie: le resultat de la requete en String
     */
    static public String executeQueryFileWithParameter(OntModel model, String filepath, String parameter) {
        File queryFile = new File(filepath);
        // use the FileManager to find the input file
        InputStream in = FileManager.get().open(filepath);
        if (in == null) {
